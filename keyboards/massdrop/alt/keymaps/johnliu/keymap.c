...
void handle_kvm(qk_tap_dance_state_t *state, void *user_data) {
    if (cur_dance(state) == SINGLE_HOLD) {
        SEND_CMD("u");
    } else {
        tap_code(KC_PGDN);
    }
...
qk_tap_dance_action_t tap_dance_actions[] = {
    [KVM] = ACTION_TAP_DANCE_FN(handle_kvm),
};
*/
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [META] = LAYOUT(
        ...
        XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,          XXXXXXX, L_T_ONF, \
...
layer_state_t layer_state_set_user(layer_state_t state) {
    switch (get_highest_layer(state)) {
        case NIL:
          ...
          led_animation_breathing = false;
          gcr_desired = LED_GCR_MAX - 80;
          break;
        case FN:
          led_lighting_mode = LED_MODE_NORMAL;
          led_animation_breathing = false;
...
led_instruction_t led_instructions[] = {
    ...
    { .flags = LED_FLAG_USE_PATTERN, .pattern_id = 2 },
